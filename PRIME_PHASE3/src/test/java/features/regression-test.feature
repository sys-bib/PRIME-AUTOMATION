Feature: Regression Testing
  ...
  Scenario: Logout
    ...
    And logout account
    #account icon : img class : img-avatar
    #logout icon : i class: fa fa-lock , sleep 5sec
    Given access prime 'https://localhost:44355/'
